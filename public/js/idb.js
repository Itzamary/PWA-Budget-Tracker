...
request.onupgradeneeded = function(event) {
    ...
    // create an object store (table) called `new-budget-tracker`, set it to have an auto incrementing primary key of sorts 
...
request.onsuccess = function(event) {
    ...
    // check if app is online, if yes run "new function name" function to send all local db data to api
    if (navigator.onLine) {
...
function saveRecord(record) {
    ...
    // access the object store for `new-budget-tracker`
